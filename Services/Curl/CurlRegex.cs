...
public class CurlRegex : Enumeration
{
     ...
     */
    public static CurlRegex GET = new CurlRegex(
        1,
        nameof(GET),
    ...
    public static CurlRegex POST = new CurlRegex(
        2,
        nameof(POST),
    ...
    public static CurlRegex HEADERS = new CurlRegex(
        3,
        nameof(HEADERS),
    ...
    public CurlRegex(int id, string name, string pattern)
        : base(id, name)
    {
    ...
    {
        public static IDictionary<string, Regex> known_curls = new Dictionary<string, Regex>();
    }
}
