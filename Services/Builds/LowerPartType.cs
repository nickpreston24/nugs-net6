...
{
    public static LowerPartType Lower = new LowerPartType(
        1,
        nameof(Lower),
        aliases: new[] { "Lower Receiver" }
    );
    public static LowerPartType LPK = new LowerPartType(
        2,
        nameof(LPK),
        aliases: new[] { "Lower Parts Kit" }
    );
    ...
    public static LowerPartType Stock = new LowerPartType(
        5,
        nameof(Stock),
        aliases: new[] { "Buttstock", "Butt Stock" }
    );
    ...
    public static implicit operator LowerPartType(string name)
    {
        ...
        var matching = LowerPartType
            .GetAll<LowerPartType>()
            .Single(lpt =>
    ...
    public LowerPartType(int id, string name, string[] aliases = null)
        : base(id, name)
    {
