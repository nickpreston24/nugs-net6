...
{
    public static Flexies Col = new Flexies(
        1,
        nameof(Col),
        "flex flex-col items-center justify-center"
    );

    public static Flexies Row = new Flexies(
        2,
        nameof(Row),
        "flex flex-row items-center justify-center"
    );

    public static Flexies ColReversed = new Flexies(
        3,
        nameof(ColReversed),
        "flex flex-col-reverse items-center justify-center"
    );

    public static Flexies RowReversed = new Flexies(
        4,
        nameof(RowReversed),
    ...
    public Flexies(int id, string name, string classname = "flex")
        : base(id, name)
    {
